...
const FormFullHistorial = () => {
  ...
  useEffect(() => {
    ...
    return () => {
        // Limpiar cualquier posible solicitud pendiente
    };
}, [ID_Historial]);
  ...
  const [nuevoAntecedenteVisible, setNuevoAntecedenteVisible] = useState(false);
    ...
    const handleSubmitNuevoAntecedente = (e) => {
        e.preventDefault();
        // Aquí puedes enviar el nuevo antecedente patológico al servidor
        console.log('Nuevo antecedente:', nuevoAntecedente);
                  ...
                  <div>
                      <div className='contendor_historial_completo'>
                            ...
                            {antecedente.map((antecedentes, index) => (
                              <div key={index} className='grupo_antecedente'>
                                <div className='datos_antecedentes'>
                                  <p>{antecedentes.nombreAntecedente}</p>
                                </div>
                                <div className='datos_antecedentes'>
                                  <label className='fecha' htmlFor="">Fecha Diagnostico:</label>
                                </div>
                                <div className='datos_antecedentes'>
                                  <p>{formatDate(antecedentes.fecha_Diagnostico)}</p>
                                </div>
                                <div className='datos_antecedentes'>
                                  <p className='tratamiento'>{antecedentes.tratamiento}</p>
                                </div>
                                <div className='datos_antecedentes'>
                                  <label htmlFor="">cuenta con tratamiento</label>
                                </div>
                                  ...
                                  <form className='form_nuevo' onSubmit={handleSubmitNuevoAntecedente}>
                                      ...
                                      <div>
                                          <input type="date" 
                                                ...
                                                value={nuevoAntecedente.fecha_Diagnostico} 
                        ...
                        <div className='contenedor_alergias'>
                          ...
                          <div><p>Medicamento: {historial.alergico_Medicamento}</p></div>
                        </div>
                    </div>
                  </div>
              ) : (
